...
Obowiązują w tym repozytorium przy generowaniu kodu, dokumentacji, komentarzy i code review.

## Język

- Komunikacja projektowa jest po polsku.
- Publiczne URL-e serwisu utrzymuj w języku angielskim.
...
- Gdy problem dotyczy testów, wskaż scenariusz, który powinien zostać sprawdzony.
